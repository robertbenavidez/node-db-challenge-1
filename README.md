...
A relational database is a method of modeling data using tables and columns, as well as ids to reference tables to one another. SQL is the language used to traverse the tables in a relational database
...
We need an cross-reference/bridge table that contains the primary id of both tables.
